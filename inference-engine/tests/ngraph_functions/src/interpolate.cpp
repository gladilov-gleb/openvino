...
std::shared_ptr<ngraph::Node> makeInterpolate(const std::vector<ngraph::Output<Node>>& in,
    ...
    const ngraph::op::v4::Interpolate::InterpolateAttrs interpolateAttributes
            (mode, shapeCalcMode, padBegin, padEnd, coordinateTransformMode, nearestMode, antialias, coeff);
